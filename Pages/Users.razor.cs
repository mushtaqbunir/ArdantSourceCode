    ...
    public partial class Users
    {
        ...
        public async void OnDeleteConfirmationSuccess(bool isAdded)
        {
            if (isAdded)
            {
                ...
                Exception registerResponse = await UsersServices.DeleteUser(UserID);
        ...
        async Task LoadRecords(int page = 1, int quantityPerPage = 200)
        {
            try
            {
                ...
                ListOfRecord = await UsersServices.GetUsers(paginationObj);
        ...
        //public static void MyActiveList(List<SystemActiveUsers> RecieveList)
        //{
        //    Users ObjUsers = new Users();

        //    ObjUsers.UpdateMyList(RecieveList);
