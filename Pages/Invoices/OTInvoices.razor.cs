...
{
    public partial class OTInvoices
    {
        ...
        public List<SelectListItem> lstOts = new List<SelectListItem>();
        ...
        public async Task LoadRecords(int page = 1, int quantityPerPage = 200)
        {
            ...
            try
            {
                ...
                ListOfRecord = await IinvoiceServices.GetNDISInvoices(paginationObj);
        ...
        public async Task LoadOTS()
        {
            try
            {
                lstOts = await IinvoiceServices.GetAllOTs();
            }
            catch (Exception ex)
            {
        ...
        public Task SetOTID(string otId)
        {
            try
            {
                OTId = otId;
        ...
        private async Task SearchChanged()
        {
            ...
            if (searchFilters.FromDate == null && searchFilters.ToDate == null && searchFilters.Status == null && searchFilters.SearchKey == null && OTId == null)
            {
            ...
            else
            {
                ...
                if (searchFilters.SearchKey != null || searchFilters.Status != null || (searchFilters.FromDate != null && searchFilters.ToDate != null) || OTId != null)
                {
                    IsloaderShow = true;
                    await Task.Delay(100);
                    CurrentUserInfoVM Userinfo = await UserauthenticationStateProvider.CurrentUser();
                    ...
                    try
                    {
                        ...
                        ListOfRecord = await IinvoiceServices.GetInvoiceSearch(paginationObj, searchFilters, OTId);
                        if (ListOfRecord != null)
                        {
                            PerPageInvoiceRecords = ListOfRecord.Invoices;
                            AllUserRecords = ListOfRecord.Invoices_All;
